...
def main() -> None:
    ...
    parser.add_argument("dat", nargs='?', default=r"C:\Users\Henri\Downloads\Junction\Data\fred-1-20251114T194658Z-1-001\fred-1\Event\events.dat", help="Path to .dat file")
